...
export async function GET(request: Request) {
  ...
  const [metrics, applications, payments, activity, admins] = await Promise.all([
  ...
  return json({ metrics, applications: applications.results, payments: payments.results, activity: activity.results, admins: admins.results });
}
